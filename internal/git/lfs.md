...
Theroretically, a repository may have a sufficient amount of LFS files to overflow the maximum manifest size of 4MB. This has yet to happen, but remains a concern. See LFS bundles [issue](https://git.act3-ace.com/ace/data/tool/-/issues/503).
